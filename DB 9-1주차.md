...
반면에 many-to-many의 예로 영화와 배우를 들자면, 내가 만약 설국열차 - 송강호를 찾고 싶어서 배우 송강호를 검색하면, 설국열차 뿐만 아니라 다양한 영화가 나온다 -> DB 입장에서 찾고자 하는 정보가 확실하게 나오지 않으므로 둘 다 primary key를 해줘야한다 -> **이렇게 해야 고유해짐**
